...
internal enum Text {
    ...
    internal enum SignIn {
        ...
        internal static let continueWithFacebook = Text.tr("Localizable", "SignIn.WithFacebook")
        internal static let continueWithApple = Text.tr("Localizable", "SignIn.WithApple")
        internal static let continueAsGuest = Text.tr("Localizable", "SignIn.AsGuest")
    }
}
